...
def run_agent_decision(
    ...
    try:
        ...
        talk_text = (
            _generate_gguf_text(model, talk_prompt, max_new_tokens=48, temperature=0.9)
            if is_gguf
            else _generate_text(model, tokenizer, talk_prompt, max_new_tokens=48, temperature=0.9)
        )
    ...
    except Exception as exc:  # noqa: BLE001 - the local adapter decides how to fall back.
        return {
            "action": None,
            "bet_amount": None,
            "explanation": "",
